...
public class GeografijaDAO {
    ...
    public void dodajGrad(Grad grad) {
        try {
            ...
            dodajGradUpit.setBoolean(5, grad.isLuka());
    ...
    public void dodajDrzavu(Drzava drzava) {
        try {
            ...
            dodajDrzavuUpit.setBoolean(4, drzava.isPomorska());
    ...
    public void izmijeniGrad(Grad grad) {
        try {
            ...
            promijeniGradUpit.setBoolean(4, grad.isLuka());
    ...
    public void izmijeniDrzavu(Drzava drzava) {
        try {
            ...
            promijeniDrzavuUpit.setBoolean(3, drzava.isPomorska());
